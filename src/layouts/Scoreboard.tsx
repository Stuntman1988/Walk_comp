...
export const Scoreboard = () => {
    ...
    const steps = [
        new StepsOfUsers(1, 'Robin', 994439),
        new StepsOfUsers(2, 'Isabell', 1367581),
        new StepsOfUsers(3, 'Eva', 1239182),
        new StepsOfUsers(4, 'Christer', 727702),
        new StepsOfUsers(5, 'Bosse', 418112),
